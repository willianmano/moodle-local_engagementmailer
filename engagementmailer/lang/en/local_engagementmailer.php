...
$string['moment'] = 'Event type';
$string['mindays'] = 'Minimum days passed';
$string['maxdays'] = 'Maximum days passed';
$string['name'] = 'Name';
...
$string['course_not_finished_in_a_period'] = 'Course not finished';
$string['global_not_access_platform_in_a_period'] = 'Platform not accessed';
$string['global_completed_course_did_not_enroll_new_course'] = 'No new enrolments after completing a course';
